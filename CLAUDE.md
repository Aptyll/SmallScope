...
**flat top-level classic scripts sharing one global scope** — fifty-five files, `core.js`
...
The game code is organized only by `// ------ name` banners inside its fifty-five files.
