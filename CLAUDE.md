...
**flat top-level classic scripts sharing one global scope** — forty-two files, `core.js`
...
The game code is organized only by `// ------ name` banners inside its forty-two files.
