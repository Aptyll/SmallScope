...
| [js/mining.js](../../js/mining.js) | ~200 | shared scope, no `window.*` export | the rocks as a thing to mine: the `ROCK_KINDS` table, the ores as carried items, and the channel on the work key |
