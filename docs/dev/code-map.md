...
| the patch tag and its notes panel, the WIKI plank heading it | `PATCH_TXT`, `PATCH_NOTES`, `buildPatchPanel`, `patchTagRect`, `patchWikiRect`/`overPatchWiki`/`drawPatchWiki`/`PW_H` | `main menu` |
