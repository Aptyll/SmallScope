...
| which role this screen plays in a match, the transport interface and the loopback solo speaks through | `NET`, `loopbackTransport`, `netSetup` | `net roles` (js/net/net.js) |
