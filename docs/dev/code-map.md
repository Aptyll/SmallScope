...
| the Steam transport under the wrapper: the lobby made or joined, its owner the host, chat updates as peer/gone, packets and their parts | `STEAM_CHUNK`, `STEAM_LOBBY_MAX`, `steamTransport` | `steam transport` (js/net/transport-steam.js) |
