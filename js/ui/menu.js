...
const PATCH_NOTES = [
  ['3.94', 'ROCKS ARE TWICE THE SIZE AND COME IN THREE KINDS - PLAIN STONE, A FROSTGLASS SPIRE AND A RARE SUNSTONE OBELISK - THAT YOU MINE BY HOLDING E WHILE THEY CRACK, AND THE ORE THEY GIVE TAKES YOUR WEAPON FROM +1 TO +5 ON THE MERCHANT\'S NEW FORGE TAB.'],
  ['3.93', 'THE FROZEN LAKES ARE DRESSED BY THE WIND: A LIGHT DUSTING OF SNOW ON THE ICE, A SNOW BANK ALONG EACH DOWNWIND SHORE, FROZEN REEDS IN CLUMPS, LONG CRACKS ACROSS THE BIG LAKES, BLOWN SNOW STREAKING OVER THEM IN THE WIND, AND A GLINT ON THE ICE ON A FROSTY NIGHT.'],
  ['3.92', 'THE SNOW REMEMBERS THE MATCH NOW: WHERE PEOPLE AND BEASTS WALK IT PACKS INTO GREY PATHS, WHERE THEY FIGHT IT GETS CHURNED UP, AND FRESH SNOW FILLS IT ALL BACK IN, FASTER ON A SNOWY DAY.'],
  ['3.91', 'A NEW MOUSE CONTROL SCHEME FOR PLAYING WITH ONE HAND: RIGHT CLICK TO WALK AND ACT, LEFT CLICK TO SHOOT AT WHAT IS UNDER THE POINTER, HOLD THE MIDDLE BUTTON FOR A WHEEL OF YOUR ABILITIES, MEALS AND FLAGS, AND THE TWO SIDE BUTTONS TO DODGE AND SLIDE. PICK IT ON THE CONTROLS PAGE.'],
  ['3.90', 'WHEN A GUST PEAKS OVER THE WOODS, A FEW PINES IN ITS PATH SHAKE A PUFF OF SNOW OFF THEIR CROWNS ONE AFTER ANOTHER, AND THE WIND CARRIES IT AS IT FALLS; AN AXE OR A SHOT INTO A PINE KNOCKS SOME LOOSE TOO.'],
  ['3.89', 'EVERY DAY HAS ITS OWN WEATHER NOW, THE SAME FOR EVERYONE IN THE MATCH: A CALM DAY WITH A FEW SLOW FLAKES, AN ORDINARY SNOWY DAY, A GROUND BLIZZARD THAT BLOWS FAST LOW STREAKS OF SNOW ACROSS THE VALLEY IN STRONG GUSTS, OR A CLEAR FROSTY DAY WITH CRISP COLD LIGHT AND SNOW THAT GLINTS AT NIGHT, AND EACH DAWN FADES THE OLD WEATHER INTO THE NEW.'],
  ['3.88', 'A TEAM COLOURS ROW ON THE GAME PAGE REPAINTS BOTH SIDES FOR COLOUR-BLIND EYES, ORANGE AGAINST BLUE, VERMILION AGAINST CYAN OR GOLD AGAINST DARK BLUE, AND MARKS EVERY RIVAL WITH A CROSS ON THE MAPS AND A NOTCHED HEALTH BAR.'],
  ['3.87', 'SIX HOG HUTS STAND DEEP IN THE WOODS THAT RING THE VALLEY, EACH IN A CLEARING WITH NO PATH TO IT AND THREE CHESTS AROUND IT, SO THE ONLY WAY IN IS TO CHOP.'],
  ['3.86', 'THE SNOW HAS SOFT WIND-LAID DRIFTS NOW, WITH FINE RIPPLES IN SOME PARTS OF THE VALLEY, BROAD SWELLS IN OTHERS AND BRIGHT FLAT SNOW WITH BLUE SHADE BEHIND EACH DRIFT IN THE REST. EVERY FIFTEEN SECONDS OR SO BY DAY, THE WIND DRIFTS A FEW FAINT STREAKS OF LOOSE SNOW SLOWLY ACROSS THE VALLEY, AND THE STARS IN A FROZEN LAKE NOW STAY PUT ON THE ICE INSTEAD OF SLIDING WITH YOUR VIEW. A CREEK THAT NEVER FREEZES RUNS DOWN THE OTHER DIAGONAL OF THE VALLEY, CORNER TO CORNER THROUGH THE WOODS, SPLITTING IT IN HALF: THE ROAD CROSSES IT IN THE MIDDLE ON A TIMBER BRIDGE WITH OPEN SIDES, THE DIRE HOLLOW AND THE ALPHA STONE STAND ON ISLANDS IN IT, AND EVERYWHERE ELSE YOU CROSS ON STEPPING STONES. STEP IN, OR GET SHOVED OFF THE BRIDGE, AND YOU GO UNDER JUST AS THROUGH THE ICE.'],
  ['3.85', 'THE WOLF DEN IS A PROPER CAVE NOW: A BIG SNOW-CAPPED BOULDER HILL WITH ICICLE FANGS OVER A BLACK MOUTH, TWO TILES WIDE, AND THE DIRE HOLLOW SHARES IT. THERE ARE SIX CAMPS NOW, THREE ON EACH SIDE OF THE ROAD, WITH ONE ALPHA STONE THAT BOTH TEAMS FIGHT OVER. NO CAMP HAS ROCKS ANY MORE: EVERY ROCK NOW STANDS IN THE OPEN SNOW NEAR THE EDGE OF THE MAP, A FEW STEPS OUT FROM THE TREES.'],
  ['3.84', 'THE DAY HAS HOURS NOW: A ROSE-PINK DAWN, A CRISP BRIGHT MIDDAY, AND A GOLDEN DUSK WITH WARM LIGHT ON THE SNOW AND COOL BLUE SHADOWS, BEFORE THE BLUE OF NIGHT.'],
  ['3.83', 'THE FOREST IS SOFTER AND NO LONGER STANDS ON A GRID: THE PINES COME IN THREE GENTLER COLOURINGS MIXED TOGETHER, THE TREES ON THE EDGE OF A WOOD ARE LIGHTER THAN THE ONES DEEP INSIDE (SO CUTTING A CLEARING BRIGHTENS IT), AND EVERY PINE STANDS A PIXEL OR TWO OFF ITS SPOT WITH ITS SHADOW BESIDE IT.'],
  ['3.82', 'BERRIES HAVE A NEW LOOK: A CLUSTER OF FOUR DARK RED BERRIES UNDER TWO LEAVES THAT FLAP, IN YOUR POUCH, YOUR BAG, THE SHOP AND ON THE SNOW.'],
  ['3.81', 'EVERY OFFER AT THE MERCHANT IS ONE ITEM NOW: BUY IT AND ITS SLOT STANDS EMPTY UNTIL THE NEXT SHIPMENT ROLLS IN AND REFILLS ALL TWELVE, AND BOTH COUNTERS SELL FROM THE SAME STOCK, SO WHOEVER GETS THERE FIRST GETS IT.'],
  ['3.80', 'A FITTING YOU FIND, BUY OR CLICK INTO YOUR WEAPON NOW ALWAYS LANDS IN FRONT OF YOUR SHOTS WHERE IT WORKS, AND A BETTER BOW KEEPS ITS NEW EMPTY CELLS IN FRONT OF THE ARROW, SO A FLAME OR SPLITTER NEVER SITS BEHIND THE ARROW DOING NOTHING.'],
  ['3.79', 'THE FROZEN LAKES HAVE REAL SHORES INSTEAD OF A STAIRCASE OF TILES - A SNOW BANK LIT BY THE SUN WITH ITS SHADE ON THE ICE, AND EVERY LAKE ONE OF TWO KINDS (A SOFT BANK, OR DEEP WATER DARKENING TO THE MIDDLE) - AND EVERYTHING STANDING ON THE SNOW, PINES, ROCKS, BUSHES, BUILDINGS, PLAYERS, BEASTS AND BOTS, THROWS ITS OWN SHADOW FROM ONE SUN.'],
  ['3.78', 'EVERY SOUND EFFECT IS LEVELLED ON HOW LOUD IT ACTUALLY IS INSTEAD OF HOW HIGH ITS WAVEFORM PEAKS, SO THE BANK NO LONGER RUNS TWENTY DECIBELS APART: THE AXE AND THE GOLD SIT QUIETER, THE TWO GOLD COINS STOP RINGING AT DIFFERENT VOLUMES, THE WOLF HOWL AND THE LEVEL-UP COME DOWN OFF THE TOP, AND EVERY CUE THAT REPEATS NOW SITS UNDER EVERY CUE THAT HAPPENS ONCE.'],
