...
const PATCH_NOTES = [
  ['3.29', 'THE WARRIOR FLIES IN WITH A LONGSWORD - THE FIRST TRUE MELEE WEAPON, A CUT THROUGH A WEDGE THE DRAW GROWS ON THE SNOW - SHIELD WALL PRESSED AGAIN IS A SLAM THAT STUNS WHAT IS AHEAD AND SPENDS THE WALL (MID-CHARGE TOO, WHICH STOPS THE CHARGE), THE RUSH WINDS UP OVER A LINE EVERYONE CAN SEE, THE STOMP AND THE SLAM SHOW THEIR REACH BEFORE THEY LAND, AND JUGGERNAUT IS GONE FOR EXECUTE: A HEAVY OVERHEAD CUT THAT LANDS HARDER THE LESS LIFE THEY HAVE LEFT.'],
  ['3.28', 'WITH A SKILL POINT UNSPENT, PRESSING AN ABILITY KEY LEVELS THAT ABILITY UP INSTEAD OF CASTING IT - THE NEXT PRESS CASTS, AND A KEY ALREADY AT ITS TOP LEVEL CASTS AS EVER.'],
