...
const PATCH_NOTES = [
  ['3.27', 'THE HUD SHOWS ONE WEAPON: THE TOOL IN HAND AND ITS BITS SIT TOP-LEFT, THE STRIP IS THE FOUR ABILITIES AND THE POUCH, AND EVERYTHING ELSE YOU CARRY IS IN A DRAWER OF SMALL CELLS THAT DROPS DOWN FROM UNDER THE WEAPON ON B OR ITS TAB AND IS INVISIBLE UNTIL THEN.'],
  ['3.26', 'CARDS LIVE IN THE POUCH WITH THE MEALS AND ARE DRAWN ON C - ONE AT RANDOM, ITS BUFF AT RANDOM, IN A BURST OF ITS COLOUR, WITH NO SCREEN TO READ - THE STRIP\'S RIGHT END IS A 2X2 OF BERRIES, FISH, GOLD AND CARDS ON SQUARE PLATES, THE PACK IS ONE ROW OF FIVE, AND A FOUND BIT LOADS INTO ANY TOOL YOU CARRY BEFORE IT TAKES A CELL.'],
  ['3.25', 'THE BOTTOM HUD IS ONE SIZE - THE STRIP\'S WELLS, THE PACK\'S CELLS AND THE SHELF\'S ARE THE SAME SQUARE WITH THE SAME DOUBLED ICONS, AND THE HUD SIZE DIAL NOW GROWS AND SHRINKS ALL THREE TOGETHER.'],
  ['3.24', 'THE CORNERS ARE QUIETER - THE BOTTOM-LEFT EVENT FEED AND THE ALIVE COUNT UNDER THE MINIMAP ARE GONE, THE CLOCK SITS CENTRED UNDER THE DISC, AND THE MINIMAP WEARS A STRONG BLACK OUTLINE INSTEAD OF A PALE HALO THAT LIT ON HOVER.'],
  ['3.23', 'THE BACKPACK HAS NO BUTTON ANY MORE - THE TEN-CELL GRID SITS FLUSH IN THE BOTTOM-RIGHT CORNER ALL MATCH ON EVERY SCREEN, ITS RIM GOES AMBER WHEN NO CELL IS FREE, AND B IS NO LONGER A KEY.'],
