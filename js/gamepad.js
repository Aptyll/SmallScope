...
// (held) and LT the slide, R3 holds the flag wheel open over the aim (and
// draws a card on a tap, the way BACK splits), down holds the build wheel,
// and BACK is the standings while held and the map on a tap.
...
const pad = {
  ...
  flag: false,                  // R3 is holding the flag wheel open
